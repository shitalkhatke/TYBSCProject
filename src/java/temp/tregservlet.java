...
@WebServlet(name = "tregservlet", urlPatterns = {"/tregservlet"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int pno=phno.length();
            if(sf<=0||su<=0||sp<=0||scp<=0||pno<=0)
            {
                ...
                RequestDispatcher rd=request.getRequestDispatcher("/treg.jsp");
        ...
        st.executeUpdate("insert into registert values('"+sfnm+"','"+sunm+"','"+spass+"','"+scpass+"',"+phno+")");
