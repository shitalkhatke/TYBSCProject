...
@WebServlet(name = "chkdbans", urlPatterns = {"/chkdbans"})
public class chkdbans extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ResultSet  rs=st.executeQuery("select * from dbtestq1 where qno=1");
                        while(rs.next())
                                      {
           ...
           rs=st.executeQuery("select * from dbtestq1 where qno=2");
                        while(rs.next())
                                      {
                         ...
                         rs=st.executeQuery("select * from dbtestq1 where qno=3");
                        while(rs.next())
                                      {
                         ...
                         rs=st.executeQuery("select * from dbtestq1 where qno=4");
                        while(rs.next())
                                      {
                         ...
                         rs=st.executeQuery("select * from dbtestq1 where qno=5");
                        while(rs.next())
                                      {
                         ...
                         rs=st.executeQuery("select * from dbtestq1 where qno=6");
                        while(rs.next())
                                      {
                         ...
                         rs=st.executeQuery("select * from dbtestq1 where qno=7");
                        while(rs.next())
                                      {
                         ...
                         rs=st.executeQuery("select * from dbtestq1 where qno=8");
                        while(rs.next())
                                      {
                         ...
                         rs=st.executeQuery("select * from dbtestq1 where qno=9");
                        while(rs.next())
                                      {
                         ...
                         rs=st.executeQuery("select * from dbtestq1 where qno=10");
                        while(rs.next())
                                      {
         ...
         RequestDispatcher rd=request.getRequestDispatcher("/2db.jsp");
