...
@WebServlet(name = "chkdsans", urlPatterns = {"/chkdsans"})
public class chkdsans extends HttpServlet {
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ResultSet  rs=st.executeQuery("select * from dstestq1 where qno=1");
                        while(rs.next())
                                      {
         ...
         RequestDispatcher rd=request.getRequestDispatcher("/4ds.jsp");
